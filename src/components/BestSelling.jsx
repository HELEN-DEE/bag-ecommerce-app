...
import bestbag1 from '../assets/best-selling-bag-1.png'
import bestbag2 from '../assets/best-selling-bag-2.png'
import bestbag3 from '../assets/best-selling-bag-3.png'
                ...
                {bestBags.map((item, index) => (
                    <div key={index} className='bg-[#F4F4F4] rounded-xl px-6 py-3'>
                        ...
                        <div className='flex items-end justify-center '>
                            <img src={item.image} alt="bag-image" className=' h-[300px] object-contain '/>
                        </div>
                    </div>
                ) )}
            </div>
